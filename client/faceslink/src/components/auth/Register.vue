    ...
    <div class="md:flex w-full">
      ...
      <div class="lg:w-1/2 w-full py-8 md:px-5 px-8">
        <div class="text-center md:mb-10 mb-5">
          <h1 class="font-bold lg:text-3xl text-2xl text-gray-900 mb-3">Sign Up.</h1>
          ...
          <div class="-mx-3">
            <div class="w-full px-5 mb-5">
              ...
              <div class="flex">
                ...
                <input type="text" class="w-full -ml-10 pl-5 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-black" placeholder="myusername">
              </div>
            </div>
          </div>
          <div class="-mx-3">
            <div class="w-full px-5 mb-5">
              ...
              <div class="flex">
                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                <input type="text" class="w-full -ml-10 pl-5 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-black" placeholder="amazing@email.com">
              </div>
            </div>
          </div>
          <div class="flex -mx-3">
            <div class="w-full px-5 mb-5">
              ...
              <div class="flex">
                ...
                <input type="password" class="w-full -ml-10 pl-5 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-black" placeholder="************">
              </div>
            </div>
          </div>
          <div class="flex -mx-3">
